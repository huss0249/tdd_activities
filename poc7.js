...
const fire = {
  up() {
    $fire.classList.remove("fire-fade", "fire-down");
    $fire.classList.add("fire-up");
  },
  down() {
    $fire.classList.remove("fire-fade", "fire-up");
    $fire.classList.add("fire-down");
  },
  stop() {
    $fire.classList.remove("fire-up", "fire-down");
    $fire.classList.add("fire-fade");
  },
  reset() {
    $fire.classList.remove("fire-up", "fire-down", "fire-fade");
  }
};
//----------------------------------------------------------
const makeFlames = (_i) => {
...
const startApp = () => {
  ...
  //----------------------------------------------------------
  document.querySelector("#stop").addEventListener("click", fire.stop);
  document.querySelector("#reset").addEventListener("click", fire.reset);
  document.querySelector("#up").addEventListener("click", fire.up);
  document.querySelector("#down").addEventListener("click", fire.down);
  //----------------------------------------------------------
  makeFlames(75);
};
startApp();
